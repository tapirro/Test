//<script language="JavaScript">
 ...
 var fr_popup_url='http://www.download.su/'; // Попап при закрытии - если пустая строка то ничего не открывать
 var fr_texts=new Array( // Собственно рекламные блоки (аккуратно с кавычками)
   '<div id=rtn4p_kni6_qiffp>Загрузка...</div>',
   '<div id="rdminfrm_15333" ><a href="http://readme.ru" target="_blank"></a></div><script charset="utf-8" type="text/javascript" language="JavaScript" src="http://readme.ru/informer/15333.js"></script> <div id="rdminfrm_15334"><a href="http://readme.ru" target="_blank"></a></div><script charset="utf-8" type="text/javascript" language="JavaScript" src="http://readme.ru/informer/15334.js"></script>'
  );
