...
abstract class BaseTest extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the succes field.
	 * @var        boolean
	 */
	protected $succes;
	...
	public function setTaskid($v)
	{
		...
		if ($this->taskid !== $v) {
			$this->taskid = $v;
			$this->modifiedColumns[] = TestPeer::TASKID;
		}
	...
	public function setUserid($v)
	{
		...
		if ($this->userid !== $v) {
			$this->userid = $v;
			$this->modifiedColumns[] = TestPeer::USERID;
		}
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = TestPeer::CONTENT;
		}
	...
	/**
	 * Set the value of [succes] column.
	 * 
	 * @param      boolean $v new value
	 * @return     Test The current object (for fluent API support)
	 */
	public function setSucces($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}
		...
		if ($this->succes !== $v) {
			$this->succes = $v;
			$this->modifiedColumns[] = TestPeer::SUCCES;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->succes = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			...
			return $startcol + 6; // 6 = TestPeer::NUM_COLUMNS - TestPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aPicture !== null && $this->taskid !== $this->aPicture->getId()) {
			$this->aPicture = null;
		}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setSucces($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TestPeer::TASKID)) $criteria->add(TestPeer::TASKID, $this->taskid);
		if ($this->isColumnModified(TestPeer::USERID)) $criteria->add(TestPeer::USERID, $this->userid);
		if ($this->isColumnModified(TestPeer::CONTENT)) $criteria->add(TestPeer::CONTENT, $this->content);
		if ($this->isColumnModified(TestPeer::SUCCES)) $criteria->add(TestPeer::SUCCES, $this->succes);
	...
	{
		if ($this->aPicture === null && ($this->taskid !== null)) {
			$this->aPicture = PicturePeer::retrieveByPk($this->taskid);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPicture->addTests($this);
			 */
		}
