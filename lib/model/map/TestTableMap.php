...
class TestTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.TestTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->setPrimaryKeyMethodInfo('test_seq');
		// columns
		$this->addPrimaryKey('ID', 'Id', 'INTEGER', true, null, null);
		$this->addForeignKey('TASKID', 'Taskid', 'INTEGER', 'picture', 'ID', true, null, null);
		$this->addForeignKey('USERID', 'Userid', 'INTEGER', 'usr', 'ID', true, null, null);
		$this->addColumn('CONTENT', 'Content', 'LONGVARCHAR', false, null, null);
		$this->addColumn('SUCCES', 'Succes', 'BOOLEAN', false, null, null);
	...
	{
    $this->addRelation('Picture', 'Picture', RelationMap::MANY_TO_ONE, array('taskid' => 'id', ), 'RESTRICT', 'RESTRICT');
